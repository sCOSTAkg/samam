  ...
  return (
    <MainLayout>
        ...
        <div className="relative z-10 h-full flex items-center">
          <div className="container mx-auto px-8">
            ...
            <p className="text-xl max-w-2xl">
              В GRANDTEX устойчивое развитие лежит в основе всего, что мы
              делаем. Мы стремимся создавать более устойчивое будущее для
              планеты и людей.
            </p>
          </div>
        </div>
      ...
      <section className="py-16 px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            <p>
              Устойчивое развитие всегда было в основе бизнеса GRANDTEX. Мы
              укрепили нашу приверженность, установив цели по четырём
              направлениям: операционное совершенство, цикличность, борьба с
              изменением климата и социальное влияние.
            </p>

            <p>
              Наш подход к устойчивости интегрирован во все аспекты бизнеса: от
              закупки сырья до производственных процессов и взаимодействия с
              сообществами. Мы считаем, что ответственная работа создаёт
              ценность для клиентов, сотрудников, обществ и окружающей среды.
            </p>
          </div>
        </div>
      </section>
            ...
            <div>
              <div className="prose prose-lg">
                <p>
                  ...
                  заводах, уделяя внимание эффективности использования ресурсов,
                  сокращению отходов и предотвращению загрязнения. Наши
                  современные предприятия используют передовые технологии, чтобы
                  минимизировать воздействие на окружающую среду, сохраняя при
                  этом высокие стандарты качества.
                </p>

                <ul>
                  <li>
                    Системы рециркуляции воды, сокращающие потребление до 40 %
                  </li>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            ...
            <div className="order-1 md:order-2">
              <div className="prose prose-lg">
                <p>
                  Мы принимаем принципы цикличной экономики, разрабатывая
                  продукты с учётом полного жизненного цикла. Это включает
                  использование побочных продуктов других отраслей, разработку
                  биоразлагаемых кож и создание программ апсайклинга.
                </p>

                <ul>
                  <li>
                    Использование обрезков кожи для создания новых продуктов
                  </li>
                  <li>
                  ...
                  <li>
                    Программы возврата кожаных изделий после использования
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            <div>
              <div className="prose prose-lg">
                <p>
                  Мы осознаём срочную необходимость борьбы с изменением климата
                  и предпринимаем действия для сокращения нашего углеродного
                  следа. Наша цель — достичь углеродной нейтральности во всех
                  операциях к 2030 году.
                </p>

                <ul>
                  <li>
                    Инвестиции в возобновляемую энергию на наших кожевенных
                    заводах
                  </li>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            ...
            <div className="order-1 md:order-2">
              <div className="prose prose-lg">
                <p>
                  Мы стремимся оказывать позитивное влияние на сообщества, в
      ...
      <section className="py-16 px-8 bg-gray-100">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold mb-8">
            Отчёты по устойчивому развитию
          </h2>
            ...
            {[2025, 2024, 2023].map((year) => (
              <div key={year} className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="text-xl font-bold mb-2">
                  Отчёт по устойчивости {year}
                </h3>
                <p className="text-gray-600 mb-4">
                  Наш ежегодный отчёт с подробностями о усилиях, достижениях и
                  целях в области устойчивости.
                </p>
                <Link
                  href="#"
      ...
      <section className="py-16 px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-4">
            Присоединяйтесь к нашему пути устойчивого развития
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Узнайте больше о наших устойчивых кожаных решениях и о том, как мы
            можем помочь вам достигнуть целей в области устойчивости.
          </p>
          <Link
            href="/contact"
