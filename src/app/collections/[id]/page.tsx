      ...
      themes: [
        {
          ...
          description:
            "Кожи, созданные для различных применений при сохранении природной привлекательности.",
        },
        {
          title: "Городская функциональность",
          description:
            "Прочные, но изысканные кожи, выдерживающие городской ритм, не жертвуя стилем.",
        },
        {
          title: "Устойчивая роскошь",
          description:
            "Премиальные кожи, созданные с использованием экологически ответственных процессов.",
        },
      ],
    },
    fw26: {
      ...
      description:
        "Наша коллекция Осень-Зима 26 сочетает прочность и изысканность, предлагая премиальные кожи, разработанные для холодного сезона.",
      longDescription:
      ...
      themes: [
        {
          ...
          description:
            "Кожи, сохраняющие свои качества и внешний вид в холодных и влажных условиях.",
        },
        {
          title: "Тактильная глубина",
          description:
            "Богатые текстуры, придающие объём и интерес сезонным дизайнам.",
        },
        {
        ...
        <section className="py-16 px-8">
          <div className="container mx-auto">
            ...
            <p className="text-lg text-gray-700 mb-12 max-w-3xl">
              Коллекция {collection.title} создана для универсального
              использования в различных категориях продукции. Вот некоторые
              ключевые области применения кож этого сезона.
            </p>
                ...
                (application, index) => (
                  <div key={index} className="text-center">
                    ...
                    <p className="text-gray-700">
                      Кожи, специально разработанные для превосходных
                      результатов в области {application.toLowerCase()}.
                    </p>
                  </div>
                ),
              )}
        ...
        <section className="py-16 px-8 bg-gray-900 text-white">
          <div className="container mx-auto text-center">
            ...
            <p className="text-lg mb-8 max-w-2xl mx-auto">
              ...
              спецификации или обсудить индивидуальные применения.
            </p>
