  ...
  return (
    <footer className="w-full py-16 px-8 bg-gray-100">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div>
          <h3 className="font-medium mb-4 font-heading">Навигация</h3>
        ...
        <div>
          <h3 className="font-medium mb-4 font-heading">Услуги</h3>
          <ul className="space-y-2">
        ...
        <div>
          <h3 className="font-medium mb-4 font-heading">Информация</h3>
          <ul className="space-y-2">
